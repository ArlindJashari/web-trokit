export const siteData = {
  ...
  services: [
    {
      id: "tolerie",
      title: "Tôlerie",
      description: "Remise en état des carrosseries aux formes et aux matériaux divers. Débosselage, planage et redressage pour voitures, camions et véhicules de collection.",
      fullDescription: "Remise en état des carrosseries aux formes et aux matériaux divers et innovants (voitures particulières, camions, bus, véhicules de collection).\n\nDémonter les pièces abîmées, rétablir leur forme initiale et remplacer les éléments non réparables par des pièces neuves.\n\nRéparer des dégâts légers par des opérations manuelles telles que débosselage, planage et redressage, tout comme de gros sinistres avec des appareils puissants et perfectionnés.",
      image: "/1.jpeg",
      icon: "Wrench",
    },
    {
      id: "peinture",
      title: "Peinture",
      description: "Peinture multi-supports (tôles, alu, plastiques) avec recherche de teintes constructeurs et utilisation exclusive de produits écologiques Sikkens AkzoNobel.",
    ...
    },
    {
      ...
      description: "Expertise en travaux de réparation ou d’embellissement sur tous types de véhicules, incluant également les appareils aéronautiques et industriels.",
    ...
    },
    {
      id: "pare-brise",
      title: "Pare-brise",
      description: "Réparation et remplacement de tout type de vitrage, quels que soient la marque ou le modèle du véhicule, avec une garantie à vie sur le travail.",
    ...
    },
    {
      ...
      description: "Redonnez un aspect lisse à votre carrosserie. Suppression des micro-rayures et nutrition de la peinture pour un magnifique effet miroir.",
    ...
    },
    {
      id: "jantes",
      title: "Jantes",
      description: "Réparation complète de jantes suite à un dégât et modification esthétique de la couleur selon vos désirs pour un rendu personnalisé.",
    ...
    {
      id: "nettoyage",
      title: "Nettoyage Offert",
      description: "À chaque réparation, un nettoyage intérieur & extérieur vous est gracieusement offert. Service également disponible indépendamment.",
  ...
  introduction: {
    ...
    text: "Fondée en 2018, Carrosserie Elite dispose d’excellentes capacités techniques et d’une grande surface de travail pour toutes réparations, quel que soit le modèle ou la marque de votre véhicule.",
    aboutFeatures: [
      {
        title: "Expertise Technique",
        text: "Savoir-faire d'une équipe hautement qualifiée pour un travail affiné, précis et soigné."
      },
      {
        title: "Mobilité Garantie",
        text: "Véhicule de remplacement gracieusement mis à disposition durant toute la réparation."
      },
      {
        title: "Éco-Responsable",
        text: "Produits écologiques Sikkens AkzoNobel à base d'eau pour préserver l'environnement."
      },
      {
        title: "Gestion Complète",
        text: "Nous gérons l'intégralité de votre sinistre directement auprès de votre assurance."
      }
    ]
  },
  features: [
    {
      title: "Multi-Marques",
      description: "Expertise technique sur tous types de véhicules, du luxe aux utilitaires.",
      icon: "Car"
    },
    {
      title: "Gestion de Sinistre",
      description: "On s'occupe de tout. Contact direct avec les assurances pour simplifier vos démarches.",
      icon: "ShieldCheck"
    },
    {
      title: "Eco-Responsable",
      description: "Utilisation exclusive de peintures et produits écologiques haut de gamme.",
      icon: "Sparkle"
    }
  ],
  projects: [
